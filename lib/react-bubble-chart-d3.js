...
BubbleChart.defaultProps = {
  ...
  bubbleOverFun: function bubbleOverFun(node) {
    console.log('Bubble ' + node.label + ' is mouseover ...');
  },
  bubbleOutFun: function bubbleOutFun(node) {
    console.log('Bubble ' + node.label + ' is mouseout ...');
  },
