  ...
  _createClass(BubbleChart, [{
    ...
    value: function renderBubbles(width, nodes, color) {
      var _props4 = this.props,
          ...
          bubbleOverFun = _props4.bubbleOverFun,
          bubbleOutFun = _props4.bubbleOutFun,
          valueFont = _props4.valueFont,
          labelFont = _props4.labelFont,
          fancyToolTips = _props4.fancyToolTips;
...
BubbleChart.defaultProps = {
  ...
  bubbleClickFun: function bubbleClickFun(label) {//console.log(`Bubble ${label} is clicked ...`)
  },
  bubbleOverFun: function bubbleOverFun(node) {//console.log(`Bubble ${node.label} is mouseover ...`)
  },
  bubbleOutFun: function bubbleOutFun(node) {//console.log(`Bubble ${node.label} is mouseout ...`)
  },
  legendClickFun: function legendClickFun(label) {//console.log(`Legend ${label} is clicked ...`)
  }
};